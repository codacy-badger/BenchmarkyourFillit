...
#    Updated: 2018/12/30 21:06:18 by abarthel         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
echo "filename: \033[92minv1.fillit\033[0m"
echo "\n\033[94merror\033[0m"
...
echo "filename: \033[92mvalid_sample.fillit\033[0m"
echo "\n\033[94mBBBB\nACCC.\nA..C.\nADD..\nDD...\033[0m"
...
echo "filename: \033[92mbenchmark11.fillit\033[0m"
echo "\n\033[94m.AABB.CC\nAADDBCC.\n.DD.BEE.\n.FF.EEGG\nFFHH.GG.\n.HHIIIJJ\n.KK.IJJ.\nKK......\033[0m"
...
echo "filename: \033[92mbenchmark14.fillit\033[0m"
echo "\n\033[94m\033[0m"
echo "\033[93min s\033[0m"
...
echo "filename: \033[92mbenchmark21.fillit\033[0m"
echo "\n\033[94m.AABB.CCDD\nAAEEBCCDD.\n.EE.BFFGG.\n.HH.FFGGJJ\nHHIIIKKJJ.\n.LLIKKMMOO\nLLNNNMMOOQ\n.PPNT.RR.Q\nPPSSTRRUUQ\n.SS.TTUU.Q\033[0m"
echo "\033[93min 0.003s\033[0m"
...
echo "filename: \033[92mhardcore_valid_sample.fillit\033[0m"
echo "\n\033[94m\033[0m"
echo "\033[93min s\033[0m"
